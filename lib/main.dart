...
class ElecEntrepriseApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final router = GoRouter(
      ...
      redirect: (context, state) {
        ...
        if (app.isLoggedIn && app.isActive && (loc == '/login' || loc == '/register' || loc == '/pending')) return '/manager';
        return null;
      },
      routes: [
        ...
        GoRoute(
          ...
          builder: (ctx, state) {
            ...
            final demande = app.demandes.where((d) => d['id'] == id).firstOrNull;
